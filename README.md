...
```bash
npm install --save-dev nikhil-angular-configs \
...
```javascript
module.exports = {
  extends: ['./node_modules/nikhil-angular-configs/eslint.config.js'],
...
```javascript
module.exports = {
  ...require('nikhil-angular-configs/prettier.config.js'),
...
```json
{
  "extends": ["nikhil-angular-configs/prettier.config.js"]
}
```
...
```json
{
  "prettier": "nikhil-angular-configs/prettier.config.js"
}
```
...
```javascript
module.exports = {
  extends: ['nikhil-angular-configs/stylelint.config.js'],
  // Override or add your custom rules here
  rules: {
    // Your custom rules
  },
